...
// receive all input values from the form
		...
		$staffno = mysqli_real_escape_string($db, $_POST[ 'staff_no' ]);
...
$query = " INSERT INTO lecturer (first_name,second_name,staff_no, email, password) VALUES('$firstname' ,'$secondname' ,'$staff_no' , '$email' , '$password' )";
